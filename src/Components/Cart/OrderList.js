  ...
  render() {
    return (
      <Fragment>
          ...
          <Row className="justify-content-center">
            <Col lg={6} md={6} sm={12}>
              <ul className="list-group">
                <li className="list-group-item">Name : mohamed </li>
                <li className="list-group-item">Email : mohamed@gmail.com </li>
              </ul>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <div className="section-title text-center mb-55">
            <h2> order history by(mohamed ) </h2>
          </div>
        ...
        <Modal show={this.state.show} onHide={this.handleClose}>
          ...
          <Modal.Body>
            <div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
              ...
              <input className="form-control" type="text" placeholder="Mohamed" />
            </div>
